                                        ...
                                        <div className="inner_widget_link">
                                            <ul className="no-ul-list filter-list">
                                                <li className="form-check">
                                                    ...
                                                    <label htmlFor="e1" className="form-check-label">Less Then Rs.10,000</label>
                                                </li>
                                                <li className="form-check">
                                                    <input id="e2" className="form-check-input" name="prices" type="radio"/>
                                                    <label htmlFor="e2" className="form-check-label">Rs.10,000 - Rs.15,000</label>
                                                </li>
                                                <li className="form-check">
                                                    <input id="e3" className="form-check-input" name="prices" type="radio"/>
                                                    <label htmlFor="e3" className="form-check-label">Rs.12,000 - Rs.25,000</label>
                                                </li>
                                                <li className="form-check">
                                                    <input id="e4" className="form-check-input" name="prices" type="radio" defaultChecked/>
                                                    <label htmlFor="e4" className="form-check-label">Rs.30,000 - Rs.35,000</label>
                                                </li>
                                                <li className="form-check">
                                                    <input id="e5" className="form-check-input" name="prices" type="radio"/>
                                                    <label htmlFor="e5" className="form-check-label">Rs.40,000 - Rs.45,000</label>
                                                </li>
                                                <li className="form-check">
                                                    <input id="e6" className="form-check-input" name="prices" type="radio"/>
                                                    <label htmlFor="e6" className="form-check-label">Rs.50,000 - Rs.55,000</label>
                                                </li>
                                                <li className="form-check">
                                                    <input id="e7" className="form-check-input" name="prices" type="radio"/>
                                                    <label htmlFor="e7" className="form-check-label">Rs.60,000 - Rs.65,000</label>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
